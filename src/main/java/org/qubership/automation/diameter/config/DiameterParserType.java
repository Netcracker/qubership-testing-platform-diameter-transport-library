...
public class DiameterParserType {
    ...
    public static Class<? extends DiameterParser> defineParserClass(final String parserTypeName) {
        ...
        switch (parserTypeName) {
            case MARBEN:
                return MarbenParser.class;
            case STANDARD:
                return StandardParser.class;
            default:
                throw new RuntimeException("Can't determine diameter parser class. Unknown type: " + parserTypeName);
        }
    }
}
