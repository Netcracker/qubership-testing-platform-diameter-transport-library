...
public class ResponseListenerTest {
    ...
    @Test
    void testMessageIsNotParsedWhenMessageIsNotCompleted() {
        ...
        Assertions.assertEquals(0, messages.length);
    }

    @Test
    void testMessageIsFullParsedCorrect() {
        ResponseListener responseListener = new ResponseListener();
    ...
    @Test
    void testFallOutMessageWhenNotCompletedMessageWereSent() {
        ResponseListener responseListener = new ResponseListener();
    ...
    void testInterceptorProcessed() {
        ...
        ExtraChannel channel = mock(ExtraChannel.class);
    ...
    //@Test
    //TODO: Actualize me
    void testErrorIsProcessedAsMessage() {
